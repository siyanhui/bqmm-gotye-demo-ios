...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.section == 0)
    {
        switch (indexPath.row) {
            ...
            {
                titleStr = @"头像";
                UIButton *headview = [[UIButton alloc] initWithFrame:CGRectMake(ScreenWidth - 20 - 46, 7, 46, 46)];
            ...
            case SettingUserTypeNickName:
            {
                ...
                UILabel *contentText = [[UILabel alloc] initWithFrame:CGRectMake(ScreenWidth - 20 - 150, 15, 150, 20)];
...
//    }
    ...
    {
        UIButton *quitButton = [[UIButton alloc] initWithFrame:CGRectMake(20, 8, ScreenWidth - 40, 33)];
