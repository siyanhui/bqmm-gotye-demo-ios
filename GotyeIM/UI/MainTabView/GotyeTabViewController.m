...
- (void)createMenuView
{
    viewMenu = [[UIView alloc] initWithFrame:CGRectMake(ScreenWidth - 122, 5, 116, 93)];
...
- (void)showAddMenu:(id)sender
{
    ...
    if(viewMenu.hidden)
    {
        ...
        UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, self.view.frame.size.height)];
        button.tag = 10000;
